...
def main():
    ...
    opt.test_split = "all_test_Covid-19-20_C1"  # all_test_Covid-19-20_C1, all_test_INSTANCE_C1
    opt.visual = False
    ...
    if opt.mode == "train":
        ...
        with open("experimentsmas.txt", "a+") as file:
            file.write(args.task + " " + opt.test_split + " " + opt.test_split + " " + "\n")
