...
class MaskDecoder(nn.Module):
    ...
    def forward(
        ...
        image_full_embedding: torch.Tensor,
        ...
        masks, iou_pred = self.predict_masks(
            ...
            image_full_embeddings=image_full_embedding,
            image_pe=image_pe,
    ...
    def predict_masks(
        self,
        image_embeddings: torch.Tensor,
        image_full_embeddings: torch.Tensor,
        ...
        upscaled_embedding = F.interpolate(upscaled_embedding, (256, 256), mode="bilinear", align_corners=False)
        combined_embedding = upscaled_embedding + image_full_embeddings
        ...
        masks = (hyper_in @ combined_embedding.view(b, c, h * w)).view(b, -1, h, w) # b 4 4h 4w 
